...
import uuid
import random
from model import R_GAMLP, JK_GAMLP, NARS_JK_GAMLP, NARS_R_GAMLP, R_GAMLP_RLU, JK_GAMLP_RLU, NARS_JK_GAMLP_RLU, \
    NARS_R_GAMLP_RLU
...
def gen_model_mag(args, num_feats, in_feats, num_classes):
    if args.method == "R_GAMLP":
        # error
        return NARS_R_GAMLP(in_feats, args.hidden, num_classes, args.num_hops + 1, num_feats, args.alpha,
                            args.n_layers_1, args.n_layers_2, args.n_layers_3, args.act, args.dropout, args.input_drop,
                            args.att_drop, args.label_drop, args.pre_process, args.residual, args.pre_dropout, args.bns)
    elif args.method == "JK_GAMLP":
        return NARS_JK_GAMLP(in_feats, args.hidden, num_classes, args.num_hops + 1, num_feats, args.alpha,
                             args.n_layers_1, args.n_layers_2, args.n_layers_3, args.act, args.dropout, args.input_drop,
                             args.att_drop, args.label_drop, args.pre_process, args.residual, args.pre_dropout,
                             args.bns)


def gen_model_mag_rlu(args, num_feats, in_feats, num_classes):
    if args.method == "R_GAMLP_RLU":
        return NARS_R_GAMLP_RLU(in_feats, args.hidden, num_classes, args.num_hops + 1, num_feats, args.alpha,
                                args.n_layers_1, args.n_layers_2, args.n_layers_3, args.act, args.dropout,
                                args.input_drop, args.att_drop, args.label_drop, args.pre_process, args.residual,
                                args.pre_dropout, args.bns)
    elif args.method == "JK_GAMLP_RLU":
        return NARS_JK_GAMLP_RLU(in_feats, args.hidden, num_classes, args.num_hops + 1, num_feats, args.alpha,
                                 args.n_layers_1, args.n_layers_2, args.n_layers_3, args.act, args.dropout,
                                 args.input_drop, args.att_drop, args.label_drop, args.pre_process, args.residual,
                                 args.pre_dropout, args.bns)
...
def gen_model(args, in_size, num_classes):
    if args.method == "R_GAMLP":
        return R_GAMLP(in_size, args.hidden, num_classes, args.num_hops + 1,
                       args.dropout, args.input_drop, args.att_drop, args.alpha, args.n_layers_1, args.n_layers_2,
                       args.act, args.pre_process, args.residual, args.pre_dropout, args.bns)
    elif args.method == "JK_GAMLP":
...
def gen_model_rlu(args, in_size, num_classes):
    if args.method == "R_GAMLP_RLU":
        return R_GAMLP_RLU(in_size, args.hidden, num_classes, args.num_hops + 1,
                           ...
                           args.n_layers_2, args.n_layers_3, args.act, args.pre_process, args.residual,
                           args.pre_dropout, args.bns)
